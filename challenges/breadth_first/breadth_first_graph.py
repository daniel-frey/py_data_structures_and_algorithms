...
class Queue(object):
    """ This creates a queue class.
    """
    def __init__(self, potential_iterable=None):
        """ Initializes function, defines datatype as always a node
        """
        self.front = None
        self.back = None
        self._length = 0
...
class Graph:
    ...
    def __repr__(self):
        """ Returns the graph's details
        """
        return(f'Graph: {self.graph}')

    def __str__(self):
        """ Returns a string of the graph's details
        """
        return f'{self.graph}'
    ...
    def add_vert(self, val):
        """ add vertice graph, check to see if the vertex already exists:
        """
    ...
    def get_neighbors(self, val):
        """ Given a val, return all all adjacent verts, return empty
