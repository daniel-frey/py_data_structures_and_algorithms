...
def test_direct_2_vertices(graph_filled_airline):
    assert graph_filled_airline
    assert get_edges(['Pandora', 'Arendelle'], graph_filled_airline) == (True, '$150')


def test_direct_3_vertices(graph_filled_airline):
...
def test_not_direct_two_vertices(graph_filled_airline):
    assert get_edges(['Pandora', 'Naboo'], graph_filled_airline) == (False, '$0')


def test_not_direct_three_vertices(graph_filled_airline):
    assert get_edges(['Pandora', 'Arendelle', 'Narnia'], graph_filled_airline) == (False, '$0')


def test_non_existing_vertices(graph_filled_airline):
...
def test_bad_input_not_list(graph_filled_airline):
    assert get_edges('Pandora', graph_filled_airline) == (False, '$0')


def test_non_input(graph_filled_airline):
